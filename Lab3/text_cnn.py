...
#this is the step that is crucial to everything, it loads the CNN layer instead of LSTM/RNN layer into the model with the correct parameters, note
#we use the same size as the second dimm of our embedding
model.add(Conv1D(256, 3, padding='valid', activation='relu',strides=1))
#add pooling layer since CNN
